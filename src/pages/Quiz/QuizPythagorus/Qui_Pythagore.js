      ...
      <div>
        <MathJax.Context>
          <div>
            ...
            <p>
                Soit \[ABC\] un triangle rectangle en \[A\]. Déterminer la longueur du côté \[BC\]. <br> 
                Vous pouvez utiliser la calculatrice pour résoudre cet exercice. <br>\[AB=3\] cm 
                <br>\[BC=\]{1:NUMERICAL:=5:0.1} cm<br>\[CA=4\] cm <br>
            </p>   
